...
DO_IMAGE_NAND = ./tools/doimage -T nand -D 0x600000 -E 0x6A0000 -P 512 -L ${BLK_SIZE} -N ${NAND_TECH} -R \
$(DRAM_REGS_FILE) u-boot-${MV_OUTPUT}.bin u-boot-${MV_OUTPUT}_$(MV_DDR_FREQ)_$(DDR_TYPE)_nand.bin
endif
ifeq ($(CONFIG_NAND_LP),y)
DO_IMAGE_NAND = ./tools/doimage -T nand -D 0x600000 -E 0x6A0000 -P 2048 -L ${BLK_SIZE} -N ${NAND_TECH} -R \
$(DRAM_REGS_FILE) u-boot-${MV_OUTPUT}.bin u-boot-${MV_OUTPUT}_$(MV_DDR_FREQ)_$(DDR_TYPE)_nand.bin
endif
DO_IMAGE_UART = ./tools/doimage -T uart -D 0x600000 -E 0x6A0000 -R \
$(DRAM_REGS_FILE) u-boot-${MV_OUTPUT}.bin u-boot-${MV_OUTPUT}_$(MV_DDR_FREQ)_$(DDR_TYPE)_uart.bin
DO_IMAGE_SPI = ./tools/doimage -T flash -D 0x600000 -E 0x6A0000 -R \
$(DRAM_REGS_FILE) u-boot-${MV_OUTPUT}.bin u-boot-${MV_OUTPUT}_$(MV_DDR_FREQ)_$(DDR_TYPE)_spi.bin
DO_IMAGE_NOR = ./tools/doimage -T flash -D 0x600000 -E 0x6A0000 -R \
...
#==============================
ifeq ($(BE),1)
	@echo "#define __BE" >> include/config.h;
...
# CPU DDR Access
#================
	@if [ "$(findstring rd88f6510sfu_config,$(RULE))" ] || [ x$(DDR_XBAR) == x1 ]; then \
...
ifneq ($(NOR),)
	$(error JFFS2 currently not supported with NOR=1... aborting)
endif
ifneq ($(NAND),1)
	$(error JFFS2 support requries NAND=1... aborting)
endif
endif
